          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Безопасные операции без верификации и KYC'
              },
              {
                icon: 'Coins',
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: 'Нет, одно из главных преимуществ наших криптоматов — полная анонимность. Никакой верификации личности не требуется.'
              },
              {
              ...
              {
                question: 'Как будет работать процесс обмена?',
